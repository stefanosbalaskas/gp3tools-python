...
# detect_gazepoint_fixations_ivt is available as gp3.detect_gazepoint_fixations_ivt(...)
# compare_gazepoint_event_detectors is available as gp3.compare_gazepoint_event_detectors(...)
# summarise_gazepoint_event_detector_agreement is available as gp3.summarise_gazepoint_event_detector_agreement(...)
# benchmark_gazepoint_event_detectors is available as gp3.benchmark_gazepoint_event_detectors(...)
```
