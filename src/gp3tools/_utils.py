...
COLUMN_CANDIDATES: dict[str, tuple[str, ...]] = {
    ...
    "pupil": ("pupil", "PUPIL", "BPOGS", "LPD", "RPD", "pupil_mean", "pupil_combined"),
    "left_pupil": ("LPD", "left_pupil", "pupil_left", "left_pupil_diameter"),
    "right_pupil": ("RPD", "right_pupil", "pupil_right", "right_pupil_diameter"),
